...
class NodeVO: Equatable
{
    ...
    init(name: String, position: CGPoint)
    {
        ...
        inputNodes = [NodeVO?]( repeating: nil,count: maxInputNodeCount)
    }
    ...
    final func updateValue()
    {
        ...
        switch nodeOperator
        {
            ...
            colorValue = candidateColor
            case .ColorMultiply:
            let inputColor = inputNodes[1]?.colorValue ?? UIColor.black
            colorValue = inputColor.multiply(value: inputValueOne)
        }
    ...
    final func getInputTypes() -> [InputOutputTypes]
    {
        ...
        if nodeType == NodeTypes.Operator
        {
            switch nodeOperator
            {
                ...
                returnArray = [InputOutputTypes](repeating: InputOutputTypes.Numeric, count: getInputCount())
                case .ColorMultiply:
    ...
    final func getOutputType() -> InputOutputTypes
    {
        ...
        switch nodeType
        {
            ...
            case .Operator:
            returnInputOutputType = getOutputTypeOfOperator(nodeOperator: nodeOperator)
        }
